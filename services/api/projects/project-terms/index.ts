...
export const ProjectTermsApi = {
  ...
  updateTermServices: (termSettingId: number, args: { term_service_ids: number[] }) =>
    baseApi.put<UpdateTermSettingResponse>(`term-settings/${termSettingId}/services`, args),
  updateTermStatus: (termSettingId: number, args: { is_active: number }) =>
    baseApi.put<UpdateTermSettingResponse>(`term-settings/${termSettingId}/status`, args),
};
