...
// TODO: Update these endpoints to the water-company-specific API paths once available.
// Currently mirrors the electric maintenance endpoints exactly.
export const ProjectWaterNotificationsApi = {
