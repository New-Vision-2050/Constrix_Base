...
import { DropdownOption, DynamicDropdownConfig } from '@/components/shared/dropdowns/types';
import { useDebouncedValue } from './useDebounce';
import { processApiResponse } from "@/components/shared/utils/dataUtils";
...
export const useDropdownSearch = ({
  ...
  const fetchOptions = useCallback(async () => {
    ...
    // Skip if search term is empty and we already have options
    // This prevents infinite requests when search term is empty
