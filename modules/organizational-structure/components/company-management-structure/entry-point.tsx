...
const CompanyManagementsStructureEntryPoint = () => {
      ...
      >
        ...
        <div className="flex-1">
          {companyData?.payload?.branches?.map((tab) => (
            ...
            >
              <BranchManagementsStructure isMainBranch={tab.id === mainBranch?.id} branchId={tab.id} companyData={companyData?.payload}  mainBranch={mainBranch}/>
            </TabsContent>
          ))}
        </div>
      </Tabs>)
...
export default CompanyManagementsStructureEntryPoint;
