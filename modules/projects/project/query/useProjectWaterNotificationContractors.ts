...
export const PROJECT_WATER_NOTIFICATION_CONTRACTORS_QUERY_KEY =
  "project-water-notification-contractors" as const;

export function useProjectWaterNotificationContractors(projectId?: string) {
  return useQuery({
    queryKey: [PROJECT_WATER_NOTIFICATION_CONTRACTORS_QUERY_KEY, projectId ?? ""],
    queryFn: async () => {
