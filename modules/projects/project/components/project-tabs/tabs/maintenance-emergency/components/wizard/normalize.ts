...
import { EMPTY_FORM, type WizardFormData } from "./types";
...
export function notificationToWizardForm(
  ...
  return {
    ...
    update_site_status_id: notification.update_site_status_id ?? "",
    ...
    contractor_representative_id:
      notification.contractor_representative_id ?? "",
    contractor_category: notification.contractor_category ?? "",
    contractor_notes: notification.contractor_notes ?? "",
    contractor_technician_id: notification.contractor_technician_id ?? "",
    contractor_technician_number:
      notification.contractor_technician_number ?? "",
    pole_number: notification.pole_number ?? "",
