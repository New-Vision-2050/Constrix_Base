...
import { useProjectAttachmentsCxt } from "@/modules/projects/project/components/project-tabs/tabs/attachments/context/project-attachments-cxt";
...
export default function ItemDetails() {
  ...
  const { selectedDocument } = useProjectAttachmentsCxt();
