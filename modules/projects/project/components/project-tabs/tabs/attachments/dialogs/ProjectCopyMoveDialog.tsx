...
import useProjectCopyMoveFile from "../hooks/use-project-copy-move-file";
...
export default function ProjectCopyMoveDialog({
  open,
  onClose,
  type,
}: PropsType) {
  ...
  const copyMoveMutation = useProjectCopyMoveFile({
    type,
    onSuccess: () => {
      clearSelectedDocs();
      onClose();
