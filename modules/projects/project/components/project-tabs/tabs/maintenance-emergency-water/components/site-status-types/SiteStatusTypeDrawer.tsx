...
import {
  useCreateWaterSiteStatusTypeMutation,
  useUpdateWaterSiteStatusTypeMutation,
...
import type { SiteStatusTypeKeyInput } from "@/services/api/projects/notifications-water/types/args";
...
export default function SiteStatusTypeDrawer({
  ...
  const createMutation = useCreateWaterSiteStatusTypeMutation(listParams);
  const updateMutation = useUpdateWaterSiteStatusTypeMutation(listParams);
