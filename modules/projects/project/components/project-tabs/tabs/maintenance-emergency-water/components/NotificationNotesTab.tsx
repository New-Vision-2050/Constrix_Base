...
import {
  useProjectWaterNotificationNotes,
  useAddProjectWaterNotificationNoteMutation,
} from "@/modules/projects/project/query/useProjectWaterNotificationMutations";
import type { ProjectNotificationNote } from "@/services/api/projects/notifications-water/types/response";
...
export default function NotificationNotesTab({
  ...
  const { data, isLoading, isError } = useProjectWaterNotificationNotes(notificationId);
  const addNoteMutation = useAddProjectWaterNotificationNoteMutation(notificationId, scope);
