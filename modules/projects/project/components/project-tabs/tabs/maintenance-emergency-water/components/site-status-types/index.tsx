...
import {
  useWaterSiteStatusTypes,
  useDeleteWaterSiteStatusTypeMutation,
} from "@/modules/projects/project/query/useWaterSiteStatusTypes";
import type { SiteStatusTypeWithKeys } from "@/services/api/projects/notifications-water/types/response";
import {
...
export default function SiteStatusTypesTab({
  ...
  const { data, isLoading } = useWaterSiteStatusTypes(listParams);
  ...
  const deleteMutation = useDeleteWaterSiteStatusTypeMutation(listParams);
