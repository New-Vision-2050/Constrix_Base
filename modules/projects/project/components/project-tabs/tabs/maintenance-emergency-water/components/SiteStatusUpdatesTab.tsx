...
import {
  useWaterCopiedSiteStatusUpdates,
  useWaterCopySiteStatusUpdateMutation,
  useWaterSiteStatusUpdates,
...
export default function SiteStatusUpdatesTab({
  ...
  const {
    ...
    isLoading,
    isError,
  } = useWaterSiteStatusUpdates(notificationId);
  const {
    data: copiedData,
    isLoading: isCopiedLoading,
    isError: isCopiedError,
  } = useWaterCopiedSiteStatusUpdates(notificationId);
...
function SiteStatusCard({
  ...
  const copyMutation = useWaterCopySiteStatusUpdateMutation(notificationId);
