...
export function notificationToWizardForm(
  ...
  return {
    ...
    contractor_number: (notification as any).contractor_number ?? "",
    contractor_representative_id: notification.contractor_representative_id ?? "",
    technician_number: (notification as any).technician_number ?? "",
    contractor_notes: notification.contractor_notes ?? "",
    round_number: (notification as any).round_number ?? "",
