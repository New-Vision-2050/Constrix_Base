...
import { useProjectWaterNotificationMapTasks } from "@/modules/projects/project/query/useProjectWaterNotificationMapTasks";
...
export default function ProjectNotificationMapTasksView({
  ...
  const { data, isLoading, isError, refetch, isFetching } =
    useProjectWaterNotificationMapTasks({ projectId, contractualEngagementKey }, {
