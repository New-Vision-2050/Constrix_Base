...
import { useReassignProjectWaterNotificationMutation } from "@/modules/projects/project/query/useProjectWaterNotificationMutations";
...
export default function ReassignTaskModal({
  ...
  const reassignMutation = useReassignProjectWaterNotificationMutation(scope);
