...
import { useUpdateProjectWaterNotificationMutation } from "@/modules/projects/project/query/useProjectWaterNotificationMutations";
...
export default function NotificationDetailEditable({
  ...
  const contractorsQuery = useProjectWaterNotificationContractors();
