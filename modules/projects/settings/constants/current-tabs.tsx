...
/** Hook that returns translated tabs with components for rendering */
export function useProjectSettingsTabs(): ProjectSettingsTab[] {
  const t = useTranslations("Projects.Settings.projectTypes.tabs");
  return [
    { name: t("projectDetails"), value: "project-details", schema_id: SCHEMA_IDS.detailsView, component: DetailsView },
    { name: t("projectTerms"), value: "project-terms", schema_id: SCHEMA_IDS.projectTerms, component: ProjectTermsView },
    { name: t("attachments"), value: "attachments", schema_id: SCHEMA_IDS.attachments, component: AttachmentsView },
    { name: t("contractors"), value: "contractors", schema_id: SCHEMA_IDS.contractors, component: ContractorsView },
    { name: t("team"), value: "team", schema_id: SCHEMA_IDS.team, component: TeamView },
    { name: t("workOrders"), value: "work-orders", schema_id: SCHEMA_IDS.workOrders, component: WorkOrdersView },
    { name: t("financial"), value: "financial", schema_id: SCHEMA_IDS.financial, component: FinancialView },
    { name: t("contractManagement"), value: "contract-management", schema_id: SCHEMA_IDS.contractManagement, component: ContractManagementView },
  ];
}
