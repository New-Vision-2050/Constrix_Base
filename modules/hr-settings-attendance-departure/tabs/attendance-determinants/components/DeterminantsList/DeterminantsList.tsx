...
const DeterminantsList: React.FC<DeterminantsListProps> = ({
  ...
  return (
    <div
      className={`${containerBg} rounded-lg overflow-hidden shadow-sm border w-full flex flex-col ${
        isDarkMode ? "border-purple-900/20" : "border-gray-200"
      }`}
    >
      ...
      >
        ...
        <div className={`${isActive ? activeTextColor : inactiveTextColor} text-sm font-medium`}>
          {t("allDeterminants")}
        </div>
      </div>
