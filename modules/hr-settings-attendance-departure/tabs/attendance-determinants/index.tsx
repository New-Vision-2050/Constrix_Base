...
function AttendanceDeterminantsTabContent() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[20%_80%] gap-2 md:gap-6 min-h-[calc(100vh-180px)] p-4">
      <Can check={[PERMISSIONS.EMPLOYEE_ATTENDANCE_CONSTRAINTS.view]}>
        {constraintsLoading ? (
...
function AttendanceDeterminantsTab() {
  return (
    <AttendanceDeterminantsProvider>
...
export default withPermissions(AttendanceDeterminantsTab, [
  PERMISSIONS.EMPLOYEE_ATTENDANCE_CONSTRAINTS.view,
]);
