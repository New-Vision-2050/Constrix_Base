...
const BranchCard = ({branch, branches, className = "", handleBranchesRefetch}: BranchCardProps) => {
    ...
    const detailRows = [
        {label: t("addNewBranchFormFieldsManagerIdLabel"), value: branch.manager?.name ?? "-"},
        {label: t("addNewBranchFormFieldsUserCountLabel"), value: branch.user_count ?? 0},
        // { label: "عدد الاقسام", value: branch.department_count ?? 0 },
        {label: t("addNewBranchFormFieldsEmailLabel"), value: branch.email ?? "—"},
        {label: t("addNewBranchFormFieldsPhoneLabel"), value: branch.phone ?? "—"},
    ];
        ...
        <div className={`w-full p-4 rounded-md ${className}`}>
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    >
                        {isMainBranch ? t("addNewBranchFormFieldsParentNameLabel") : t("addNewBranchFormFieldsBranchNameLabel")}
                    </Badge>
