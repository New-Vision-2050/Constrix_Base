...
export default function WorkPanelSettingsView() {
  ...
  const settingCards: SettingCard[] = [
    ...
    },
    {
      ...
      title: t("resultsEvaluationSettings"),
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {settingCards.map((card) => (
          <Link
            ...
            className={
              card.disabled
                ? "pointer-events-none cursor-not-allowed opacity-50 hover:shadow-none"
                : "pointer-events-auto cursor-pointer opacity-100 hover:shadow-lg hover:shadow-primary/20"
            }
          >
