...
// Factory function to create schemas with specific locale
export const createProductSchemas = (locale: string = "ar") => {
  ...
  return {
    productTaxSchema,
    productDetailSchema,
    productCustomFieldSchema,
    productSeoSchema,
    createProductSchema,
  };
};

// Default export for backward compatibility (using Arabic as default)
export const {
  productTaxSchema,
  productDetailSchema,
  productCustomFieldSchema,
