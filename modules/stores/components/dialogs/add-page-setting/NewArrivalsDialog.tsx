...
export function NewArrivalsDialog({
  open,
  onClose,
  onSuccess,
  pageId,
}: NewArrivalsDialogProps) {
  ...
  const form = useForm<PageFormData>({
    ...
    defaultValues: { type: "new_arrival", url: "", title: "", description: "" },
  });
  ...
  useEffect(() => {
    if (!open) {
      reset({ type: "new_arrival", url: "", title: "", description: "" });
  ...
  const onSubmit = async (data: PageFormData) => {
    try {
      ...
      formData.append("type", "new_arrival");
