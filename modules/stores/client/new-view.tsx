...
export default function StoresView() {
  ...
  const [progressValue] = useState(75); // Placeholder value
    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Left Column - Progress Status & Basic Information */}
          ...
          {/* Middle Column - Addresses/Titles */}
          <Card className="bg-sidebar">
            <CardHeader>
          ...
          {/* Right Column - Complaints/Suggestions and Applications */}
          <div className="space-y-6">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="flex items-center gap-4 text-sm text-muted-foreground">
                            <span>
                              تاريخ الاستلام: {application.submissionDate}
                            </span>
