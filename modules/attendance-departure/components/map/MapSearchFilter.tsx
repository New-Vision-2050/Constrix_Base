...
const MapSearchFilter: React.FC = () => {
  ...
  const { toggleView, searchText, setSearchText, refetchMapTrackingData } =
    useAttendance();
  ...
  const inputPlaceholderColor = isDarkMode
  ...
  return (
    ...
    >
      <div className="flex-grow relative">
        ...
        />
        <Search
          className="absolute left-3 top-[9px]"
      ...
      <div className="flex items-center gap-2">
        ...
        <Button
          ...
          className="bg-[#FF3B8B] hover:bg-[#E61B70] text-white h-[36px] min-w-[100px] rounded-md"
          size="sm"
          onClick={() => refetchMapTrackingData()}
        >
