  ...
  return (
    <div className="px-6 py-4 flex flex-col gap-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        {/* user logs */}
        <EmptyUserDataSection
          title={t("sections.activityLog.title")}
          description={t("sections.activityLog.emptyDescription")}
        />
        {/* incoming meetings */}
        <EmptyUserDataSection
          title={t("sections.upcomingMeetings.title")}
          description={t("sections.upcomingMeetings.emptyDescription")}
          actionsBtn={
            <Button variant="text" color="primary" startIcon={<PlusIcon />}>
              {t("sections.upcomingMeetings.requestMeetingBtn")}
            </Button>
          }
        />
      </div>
      ...
      <EmptyUserDataSection
        ...
        description={t("sections.requests.emptyDescription")}
      />
      {/* price offers */}
      <EmptyUserDataSection
        title={t("sections.priceOffers.title")}
        description={t("sections.priceOffers.emptyDescription")}
      />
      {/* contracts */}
      <EmptyUserDataSection
        title={t("sections.contracts.title")}
        description={t("sections.contracts.emptyDescription")}
      />
    </div>
  );
}
