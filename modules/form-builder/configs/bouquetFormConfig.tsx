...
export function GetBouquetFormConfig(
  ...
  return {
        ...
        fields: [
          ...
          },
          {
            ...
            postfix: (
              <PeriodUnitSelector
                formId="bouquet-form"
                fieldName="subscription_period_unit"
              />
            ),
          },
    ...
    editDataTransformer: (data) => {
      (data.name = data.name),
        ...
        (data.company_fields = data.company_fields?.map(
          (item: any) => item.id
        ));
      ...
      try {
        ...
        const transformedData = {
          ...
          subscription_period_unit:
            (formData.subscription_period_unit as string) || "month", // Default to month if not selected
