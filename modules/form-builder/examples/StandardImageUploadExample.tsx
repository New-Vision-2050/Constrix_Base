...
const StandardImageUploadExample: React.FC = () => {
  // Define the form configuration with an image upload field
  const formConfig: FormConfig = {
    title: "Standard Image Upload Example",
    description: "This form demonstrates the image upload field functionality with the standard form builder",
    sections: [
      {
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-2xl font-bold mb-6">Standard Image Upload Form Example</h1>
      ...
      <div className="mt-8 p-4 bg-muted rounded-md">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>
            This example uses the standard SheetFormBuilder component (not the React Hook Form version).
          </li>
          <li>
...
export default StandardImageUploadExample;