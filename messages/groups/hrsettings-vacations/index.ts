...
export const hrsettingsVacationsMessages = new MessagesGroup({
  ...
  publicLeaves: new MessagesGroup({
    ...
    table: new MessagesGroup({
      ...
      headerSectionLabel: _m("Public holidays context", "سياق الإجازات الرسمية"),
      headerBreadcrumbLabel: _m("Breadcrumb", "مسار التنقل"),
      headerViewingYear: _m("Viewing year", "عرض سنة"),
      headerYearStatus: _m("Year status", "حالة السنة"),
      headerActiveYear: _m("Active year", "سنة نشطة"),
      headerHistoricalYear: _m("Historical year", "سنة سابقة"),
      headerBranch: _m("Branch", "الفرع"),
      headerStatistics: _m("Statistics", "إحصائيات"),
      headerYearsCount: _m("Years with holidays", "سنوات بها إجازات"),
      headerSelectedPeriod: _m("Selected period", "الفترة المحددة"),
      monthFilter: _m("Month", "الشهر"),
      countryFilter: _m("Country", "الدولة"),
      startDateFilter: _m("Start date", "تاريخ البداية"),
      endDateFilter: _m("End date", "تاريخ النهاية"),
      months: new MessagesGroup({
        1: _m("January", "يناير"),
        2: _m("February", "فبراير"),
        3: _m("March", "مارس"),
        4: _m("April", "أبريل"),
        5: _m("May", "مايو"),
        6: _m("June", "يونيو"),
        7: _m("July", "يوليو"),
        8: _m("August", "أغسطس"),
        9: _m("September", "سبتمبر"),
        10: _m("October", "أكتوبر"),
        11: _m("November", "نوفمبر"),
        12: _m("December", "ديسمبر")
      }),
      submitButtonText: _m("Save", "حفظ"),
      cancelButtonText: _m("Cancel", "إلغاء"),
