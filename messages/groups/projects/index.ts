...
export const projectMessages = new MessagesGroup({
  ...
  tabs: new MessagesGroup({
    ...
    maintenanceAndEmergencies: _m("Maintenance & Emergencies", "الصيانة والطوارئ"),
  }),
  ...
  maintenanceEmergency: new MessagesGroup({
    ...
    notifications: new MessagesGroup({
      ...
      mapNoTasksForFilter: _m("No tasks match the selected filter", "لا توجد مهام تطابق التصفية المحددة"),
