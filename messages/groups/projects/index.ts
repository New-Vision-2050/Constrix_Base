...
export const projectMessages = new MessagesGroup({
  ...
  maintenanceEmergency: new MessagesGroup({
    ...
    notifications: new MessagesGroup({
      ...
      wfmNotificationNumber: _m(
        "WFM Notification / Report Number",
        "رقم إشعار/بلاغ الـ WFM",
      ),
      notificationType: _m("Notification Type", "نوع الاشعار"),
      wfmNotificationType: _m(
        "WFM Notification / Report Type",
        "نوع إشعار/بلاغ الـ WFM",
      ),
      updateSiteStatus: _m("Update Formula", "صيغة التحديث"),
      selectUpdateSiteStatus: _m(
        "Select update formula",
        "اختر صيغة التحديث",
      ),
      siteStartDate: _m("Site Start Date", "تاريخ مباشرة الموقع"),
      siteStartTime: _m("Site Start Time", "وقت مباشرة الموقع"),
      workDescription: _m("Work Description", "وصف العمل"),
      contractorNumber: _m("Contractor Number", "رقم المقاول"),
      contractorTechnician: _m("Contractor Technician", "فني المقاول"),
      chooseContractorTechnician: _m(
        "Choose contractor technician",
        "اختر فني المقاول",
      ),
      contractorTechnicianNumber: _m(
        "Technician Number",
        "رقم الفني",
      ),
      poleNumber: _m("Pole Number", "رقم الجول"),
