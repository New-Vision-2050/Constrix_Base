...
export const projectMessages = new MessagesGroup({
  ...
  tabs: new MessagesGroup({
    ...
    maintenanceAndEmergencies: _m(
      "Maintenance & Emergencies - Electric Company",
      "الصيانة والطوارئ - شركة كهرباء",
    ),
    maintenanceAndEmergenciesWater: _m(
      "Maintenance & Emergencies - Water Company",
      "الصيانة والطوارئ - شركة المياه",
    ),
  ...
  maintenanceEmergency: new MessagesGroup({
    ...
    notifications: new MessagesGroup({
      ...
      addNotification: _m("Add Electric Notification", "إضافة إشعار كهرباء"),
      ...
      // Wizard
      wizard: _m("Add Electric Notification", "إضافة إشعار كهرباء"),
      wizardEdit: _m("Edit Electric Notification", "تعديل إشعار كهرباء"),
      ...
      copiedToClipboard: _m("Copied to clipboard", "تم النسخ إلى الحافظة"),
      copyFailed: _m("Copy failed", "فشل النسخ"),
      ...
      noKeys: _m("No keys defined yet", "لا توجد مفاتيح محددة"),
      summarySiteStatus: _m("Site Status", "حالة الموقع"),
      copiedToClipboard: _m("Copied to clipboard", "تم النسخ"),
      copyFailed: _m("Failed to copy", "فشل النسخ"),
      copyReport: _m("Copy", "نسخ"),
    }),
    siteStatusTypes: new MessagesGroup({
      title: _m("Site Status Types", "أنواع حالة الموقع"),
      nameAr: _m("Arabic Name", "الاسم بالعربية"),
      nameEn: _m("English Name", "الاسم بالإنجليزية"),
      key: _m("Key", "المفتاح"),
      fieldType: _m("Field Type", "نوع الحقل"),
      options: _m("Options", "الخيارات"),
      addOption: _m("Add Option", "إضافة خيار"),
      noOptions: _m("No options added yet", "لا توجد خيارات مضافة"),
      optionPlaceholder: _m("Option value", "قيمة الخيار"),
      showInSiteStatusUpdates: _m(
        "Show in Site Status Updates",
        "العرض في التحديث الدوري للموقع",
      ),
      sortOrder: _m("Sort Order", "ترتيب العرض"),
      isActive: _m("Active", "نشط"),
      inactive: _m("Inactive", "غير نشط"),
      addType: _m("Add Site Status Type", "إضافة نوع حالة الموقع"),
      editType: _m("Edit Site Status Type", "تعديل نوع حالة الموقع"),
      addKey: _m("Add Key", "إضافة مفتاح"),
      editKey: _m("Edit Key", "تعديل المفتاح"),
      manageKeys: _m("Manage Keys", "إدارة المفاتيح"),
      noKeys: _m("No keys defined yet", "لا توجد مفاتيح محددة بعد"),
      noTypes: _m("No site status types found", "لا توجد أنواع حالة الموقع"),
      keysCount: _m("Keys Count", "عدد المفاتيح"),
      typeCreated: _m(
        "Site status type created",
        "تم إنشاء نوع حالة الموقع",
      ),
      typeUpdated: _m(
        "Site status type updated",
        "تم تحديث نوع حالة الموقع",
      ),
      typeDeleted: _m(
        "Site status type deleted",
        "تم حذف نوع حالة الموقع",
      ),
      typeDeleteError: _m(
        "Could not delete site status type",
        "تعذر حذف نوع حالة الموقع",
      ),
      keyCreated: _m("Key created", "تم إنشاء المفتاح"),
      keyUpdated: _m("Key updated", "تم تحديث المفتاح"),
      keyDeleted: _m("Key deleted", "تم حذف المفتاح"),
      keyDeleteError: _m("Could not delete key", "تعذر حذف المفتاح"),
      deleteTypeTitle: _m(
        "Delete Site Status Type",
        "حذف نوع حالة الموقع",
      ),
      deleteTypeBody: _m(
        "Are you sure you want to delete this site status type?",
        "هل أنت متأكد من حذف نوع حالة الموقع هذا؟",
      ),
      deleteKeyTitle: _m("Delete Key", "حذف المفتاح"),
      deleteKeyBody: _m(
      ...
      all: _m("All", "الكل"),
      loadError: _m(
        "Could not load site status types",
        "تعذر تحميل أنواع حالة الموقع",
      ),
      ...
      fieldTypes: new MessagesGroup({
        text: _m("Text", "نص"),
        number: _m("Number", "رقم"),
        date: _m("Date", "تاريخ"),
        select: _m("Select", "قائمة منسدلة"),
      }),
    }),
  }),
  maintenanceEmergencyWater: new MessagesGroup({
    title: _m("Maintenance & Emergencies - Water Company", "الصيانة والطوارئ - شركة المياه"),
    comingSoon: _m("Coming soon", "قريباً"),
    tabs: new MessagesGroup({
      notifications: _m("Notifications", "الإشعارات"),
      siteStatusTypes: _m("Site Status Types", "أنواع حالة الموقع"),
    ...
    notifications: new MessagesGroup({
      title: _m("Notifications", "الإشعارات"),
      addNotification: _m("Add Water Notification", "إضافة إشعار مياه"),
      showMap: _m("Show Map", "عرض الخريطة"),
      backToTable: _m("Back to table", "العودة للجدول"),
      mapTasksTitle: _m("Notification tasks map", "خريطة مهام الإشعارات"),
      refreshMap: _m("Refresh", "تحديث"),
      ...
      clearFilters: _m("Clear filters", "مسح التصفية"),
      number: _m("Number", "الرقم"),
      notificationNumber: _m("Notification Number", "رقم اشعار/بلاغ الـ WFM"),
      notification_number: _m("Notification Number", "رقم اشعار/بلاغ الـ WFM"),
      notificationType: _m("Notification Type", "نوع اشعار/بلاغ الـ WFM"),
      magdy_number: _m("Magdy Number", "رقم مجدي"),
      machineNumber: _m("Machine Number", "رقم المعدة"),
      feeder_number: _m("Feeder Number", "رقم المغذي"),
      date: _m("Date", "التاريخ"),
      ...
      createdBy: _m("Created by", "تم الإنشاء بواسطة"),
      assignedTo: _m("Assigned to", "مُسند إلى"),
      wizard: _m("Add Water Notification", "إضافة إشعار مياه"),
      wizardEdit: _m("Edit Water Notification", "تعديل إشعار مياه"),
      step1: _m("Notification Info", "بيانات الإشعار"),
      step2: _m("Contractor Info", "بيانات المقاول"),
      step3: _m("Location", "الموقع"),
      step4: _m("Assign to Employee", "الإسناد لموظف"),
      ...
      send: _m("Send Notification", "إرسال الإشعار"),
      update: _m("Update Notification", "تحديث الإشعار"),
      confirmData: _m("Data reviewed and confirmed", "تمت مراجعة البيانات والتأكد من صحتها"),
      readyToSend: _m("Ready to send", "جاهز للإرسال"),
      ...
      invalidLocationLink: _m("Invalid location link", "رابط موقع غير صالح"),
      locationOutsideAllowedZone: _m("Location is outside the allowed zone", "الموقع خارج المنطقة المسموح بها"),
      searchMap: _m("Search map", "البحث في الخريطة"),
      searchNoResults: _m("No results", "لا توجد نتائج"),
      myLocation: _m("My location", "موقعي الحالي"),
      geolocationNotSupported: _m("Geolocation is not supported by your browser", "المتصفح لا يدعم تحديد الموقع"),
      geolocationDenied: _m("Could not get your location", "تعذر الحصول على موقعك"),
      employees: _m("Employees", "الموظفين"),
      loading: _m("Loading...", "جاري التحميل..."),
      employeeName: _m("Employee Name", "اسم الموظف"),
      lastUpdate: _m("Last Update", "آخر تحديث"),
      ...
      allStatuses: _m("All statuses", "كل الحالات"),
      allBranches: _m("All branches", "كل الفروع"),
      noEmployeesMatch: _m("No employees match the filters", "لا يوجد موظفين مطابقين للتصفية"),
      branch: _m("Branch", "الفرع"),
      availableFar: _m("Available - Far", "متاح - بعيد"),
      notConnected: _m("Not Connected", "غير متصل"),
      absent: _m("Absent", "غائب"),
      contractorNumber: _m("Contractor Number", "رقم المقاول"),
      contractorTechnicalNumber: _m("Contractor Technical Number", "رقم الفني"),
      contractorCategory: _m("Contractor Technician", "فني المقاول"),
      contractorNotes: _m("Contractor Notes", "ملاحظات المقاول"),
      permitSource: _m("Round Number", "رقم الجول"),
      permitRecipient: _m("Permit Recipient", "مستلم التصريح"),
      copiedToClipboard: _m("Copied to clipboard", "تم النسخ إلى الحافظة"),
      copyFailed: _m("Copy failed", "فشل النسخ"),
      repairPoint: _m("Repair Point", "نقطة الإصلاح"),
      ...
      locationRadius: _m("Repair Radius (m)", "نطاق الإصلاح (م)"),
      locationLink: _m("Location Link", "رابط الموقع"),
      taskDate: _m("Task Date", "تاريخ مباشرة الموقع"),
      taskTime: _m("Site Start Time", "وقت مباشرة الموقع"),
      durationHours: _m("Duration (hours)", "المدة (ساعات)"),
      notes: _m("Notes", "ملاحظات"),
      siteStatusType: _m("Notification Format", "صيغة الإشعار"),
      selectSiteStatusType: _m("Select notification format", "اختر صيغة الإشعار"),
      ...
      siteStatusReviewedBy: _m("Reviewed by", "تمت المراجعة بواسطة"),
      siteStatusProcessSteps: _m("Approval Steps", "خطوات الاعتماد"),
      noSiteStatusUpdates: _m("No site status updates", "لا توجد تحديثات للموقع"),
      noCopiedSiteStatusUpdates: _m("No copied site status updates", "لا توجد تحديثات منسوخة للموقع"),
      siteStatusLoadError: _m("Could not load site status updates", "تعذر تحميل تحديثات الموقع"),
      siteStatusOriginal: _m("Original", "أصلي"),
      siteStatusCopied: _m("Copied", "منسوخ"),
      downloadImage: _m("Download", "تحميل"),
      downloadAllImages: _m("Download all (ZIP)", "تحميل الكل (ZIP)"),
      ...
      addNote: _m("Add Note", "إضافة ملاحظة"),
      addingNote: _m("Adding…", "جاري الإضافة…"),
      notesLoadError: _m("Could not load notes", "تعذر تحميل الملاحظات"),
      addNoteError: _m("Could not add note", "تعذر إضافة الملاحظة"),
      addNoteSuccess: _m("Note added", "تم إضافة الملاحظة"),
      noteTooLong: _m("Note is too long (max 1000 characters)", "الملاحظة طويلة جداً (الحد الأقصى 1000 حرف)"),
      lastNote: _m("Last Note", "آخر ملاحظة"),
      copyReport: _m("Copy report", "نسخ التقرير"),
      copiedToClipboard: _m("Report copied to clipboard", "تم نسخ التقرير"),
      copyFailed: _m("Could not copy report", "تعذر نسخ التقرير"),
      ...
      yes: _m("Yes", "نعم"),
      no: _m("No", "لا"),
      reportTitle: _m("Work Accomplishment Report & Operation Permit", "تقرير إنجاز عمل وتصريح تشغيل"),
      reportConsultant: _m("Consultant", "الاستشاري"),
      reportContractor: _m("Contractor", "المقاول"),
      reportDate: _m("Date", "التاريخ"),
      reportNotificationNumber: _m("Notification No.", "رقم البلاغ"),
      ...
      reportAuthorizationSource: _m("Permit Source", "مصدر التصريح"),
      reportAuthorizationReceiver: _m("Permit Receiver", "مستلم التصريح"),
      reportEstimatedTime: _m("Estimated Completion Time", "الوقت المتوقع لإنهاء العمل"),
      reportOperationStatus: _m("Operation Status", "حالة التشغيل"),
      reportLocation: _m("Geographic Location", "الموقع الجغرافي"),
      reportMapLink: _m("Map Link (Google Maps)", "رابط الموقع (Google Maps)"),
      reportOpenMap: _m("Open Map", "فتح الموقع"),
      ...
      charts: new MessagesGroup({
        ...
        severityDistribution: _m("Severity", "الخطورة"),
        projectDistribution: _m("Project Distribution", "توزيع المشاريع"),
        assignedEmployeeDistribution: _m("Assigned Employees", "الموظفون المسؤولون"),
        contractorDistribution: _m("Contractors", "المقاولون"),
        contractorCategoryDistribution: _m("Contractor Category", "فئة المقاول"),
        trendDistribution: _m("Monthly Trend", "الاتجاه الشهري"),
        total: _m("Total", "الإجمالي"),
        clickToFilter: _m("Click to filter", "اضغط للتصفية"),
        fullscreen: _m("Fullscreen", "ملء الشاشة"),
    ...
    siteStatusTypes: new MessagesGroup({
      ...
      noOptions: _m("No options added yet", "لا توجد خيارات مضافة"),
      optionPlaceholder: _m("Option value", "قيمة الخيار"),
      showInSiteStatusUpdates: _m("Show in Site Status Updates", "العرض في التحديث الدوري للموقع"),
      sortOrder: _m("Sort Order", "ترتيب العرض"),
      isActive: _m("Active", "نشط"),
      inactive: _m("Inactive", "غير نشط"),
      addType: _m("Add Site Status Type", "إضافة نوع حالة الموقع"),
      ...
      noTypes: _m("No site status types found", "لا توجد أنواع حالة الموقع"),
      keysCount: _m("Keys Count", "عدد المفاتيح"),
      typeCreated: _m("Site status type created", "تم إنشاء نوع حالة الموقع"),
      typeUpdated: _m("Site status type updated", "تم تحديث نوع حالة الموقع"),
      typeDeleted: _m("Site status type deleted", "تم حذف نوع حالة الموقع"),
      typeDeleteError: _m("Could not delete site status type", "تعذر حذف نوع حالة الموقع"),
      keyCreated: _m("Key created", "تم إنشاء المفتاح"),
      keyUpdated: _m("Key updated", "تم تحديث المفتاح"),
      keyDeleted: _m("Key deleted", "تم حذف المفتاح"),
      keyDeleteError: _m("Could not delete key", "تعذر حذف المفتاح"),
      deleteTypeTitle: _m("Delete Site Status Type", "حذف نوع حالة الموقع"),
      deleteTypeBody: _m("Are you sure you want to delete this site status type?", "هل أنت متأكد من حذف نوع حالة الموقع هذا؟"),
      deleteKeyTitle: _m("Delete Key", "حذف المفتاح"),
      deleteKeyBody: _m("Are you sure you want to delete this key?", "هل أنت متأكد من حذف هذا المفتاح؟"),
      cancel: _m("Cancel", "إلغاء"),
      create: _m("Create", "إنشاء"),
      save: _m("Save", "حفظ"),
      update: _m("Update", "تحديث"),
      ...
      status: _m("Status", "الحالة"),
      all: _m("All", "الكل"),
      loadError: _m("Could not load site status types", "تعذر تحميل أنواع حالة الموقع"),
      siteStatusType: _m("Site Status Type", "نوع حالة الموقع"),
      selectSiteStatusType: _m("Select Site Status Type", "اختر نوع حالة الموقع"),
      notificationTypes: _m("Notification Types", "أنواع الإشعارات"),
      selectNotificationTypes: _m("Select Notification Types", "اختر أنواع الإشعارات"),
      fieldTypes: new MessagesGroup({
        text: _m("Text", "نص"),
        number: _m("Number", "رقم"),
        date: _m("Date", "تاريخ"),
  ...
  documentRequirements: new MessagesGroup({
    ...
    add: _m("Add", "إضافة"),
    cancel: _m("Cancel", "إلغاء"),
    listTitle: _m("Requirements list", "قائمة المتطلبات"),
    addNewRow: _m("Add new requirement", "إضافة متطلب جديد"),
    delete: _m("Remove", "إلغاء"),
    frequencyDay: _m("Day", "يوم"),
    frequencyWeek: _m("Week", "أسبوع"),
    frequencyMonth: _m("Month", "شهر"),
    weekInterval: _m("Repeat every (weeks)", "التكرار كل (عدد الأسابيع)"),
    ...
    validation: new MessagesGroup({
      ...
      requiredDocumentNameRequired: _m("Required document name is required", "اسم المستند المطلوب مطلوب"),
      documentRequired: _m("Document is required", "الوثيقة مطلوبة"),
      documentTypeRequired: _m("Document type is required", "نوع الوثيقة مطلوب"),
