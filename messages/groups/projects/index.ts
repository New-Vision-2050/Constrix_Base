  ...
  maintenanceEmergency: new MessagesGroup({
    ...
    notifications: new MessagesGroup({
      ...
      types: new MessagesGroup({
        maintenance: _m("Maintenance", "صيانة"),
        emergency: _m("Emergency", "طوارئ"),
        violation: _m("Violation", "مخالفة"),
        inspection: _m("Inspection", "تفتيش"),
        repair: _m("Repair", "إصلاح عطل"),
        installation: _m("Installation", "تركيب"),
        removal: _m("Removal", "إزالة"),
      }),
      ...
      contractorMobile: _m("Contractor Mobile", "رقم جوال المقاول"),
