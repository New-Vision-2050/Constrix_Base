...
export const ReportFormsMessages = new MessagesGroup({
  ...
  form: new MessagesGroup({
    ...
    createSuccess: _m(
      "Report form created successfully!",
      "تم إنشاء نموذج التقرير بنجاح!",
    ),
    createError: _m(
      "Failed to create report form. Please try again.",
      "فشل إنشاء نموذج التقرير. يرجى المحاولة مرة أخرى.",
    ),
    updateSuccess: _m(
      "Report form updated successfully!",
      "تم تحديث نموذج التقرير بنجاح!",
    ),
    updateError: _m(
      "Failed to update report form. Please try again.",
      "فشل تحديث نموذج التقرير. يرجى المحاولة مرة أخرى.",
    ),
  }),
  ...
  loadListError: _m("Could not load report forms", "تعذر تحميل نماذج التقارير"),
});
