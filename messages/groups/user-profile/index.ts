...
export const userProfileMessages = new MessagesGroup({
    header: new MessagesGroup({
        placeholder: new MessagesGroup({
            ...
            contractualJobData: _m("Contractual Job Data", "بيانات الوظيفة التعاقدية"),
            contractualContractData: _m("Contractual Contract Data", "بيانات العقد التعاقدية"),

        }),
        salary: new MessagesGroup({
            title: _m("Salary", "الراتب"),
            ...
            hourlyRatePlaceholder: _m("Hourly Rate", "قيمة الساعة"),
            salaryDescriptionRequired: _m("Salary Description is required", "وصف الراتب مطلوب"),
            salaryDescriptionPlaceholder: _m("Salary Description", "وصف الراتب"),
            salaryDescription: _m("Salary Description", "وصف الراتب"),
            paymentPeriodRequired: _m("Payment Period is required", "فترة الدفع مطلوبة"),
            paymentPeriodPlaceholder: _m("Payment Period", "فترة الدفع"),
            paymentPeriod: _m("Payment Period", "فترة الدفع"),
            basicSalaryAmountRequired: _m("Basic Salary Amount is required", "قيمة الراتب الاساسي مطلوبة"),
            basicSalaryAmountPlaceholder: _m("Basic Salary Amount", "قيمة الراتب الاساسي"),
            basicSalaryAmount: _m("Basic Salary Amount", "قيمة الراتب الاساسي"),
    ...
    tabs: new MessagesGroup({
        financialData: new MessagesGroup({
            contractualData: _m("Contractual Data", "بيانات التعاقدية"),
            addNewPrivilege: _m("Add New Privilege", "أضافة امتياز جديد"),
            noData: _m("No Privileges Found", "لا توجد امتيازات"),
            noDataSubTitle: _m("No privileges or allowances added yet. Click the button above to add new privilege.", "لا توجد امتيازات أو بدلات مضافة. انقر على الزر أعلاه لإضافة امتياز جديد"),
            privilegesAndAllowances: _m("Privileges and Allowances", "امتيازات واجازات"),
            privilegesAndAllowancesDescription: _m("Privileges and Allowances Description", "وصف امتيازات واجازات"),
            privilegesAndAllowancesTitle: _m("Privileges and Allowances", "امتيازات واجازات"),
            salaries: _m("Salaries", "الراتب"),
            privilegeForm: new MessagesGroup({
                typePrivilegeLabel: _m("Allowance Type (Family - Individual)", "نوع البدل (عائلي - فردي)"),
                typePrivilegePlaceholder: _m("Select Allowance", "اختر البدل"),
                typePrivilegeRequired: _m("Enter Allowance", "ادخل البدل"),
                typeAllowanceLabel: _m("Allowance Type (Fixed - Percentage - Saving)", "نوع البدل (ثابت - نسبة - توفير)"),
                typeAllowancePlaceholder: _m("Select Allowance", "اختر البدل"),
                typeAllowanceRequired: _m("Enter Allowance", "ادخل البدل"),
                chargeAmountPercentageLabel: _m("Percentage Rate from Base Salary", "معدل حساب النسبة من اصل الراتب"),
                chargeAmountPercentagePlaceholder: _m("Percentage Rate from Base Salary", "معدل حساب النسبة من اصل الراتب"),
                chargeAmountPercentageRequired: _m("Percentage Rate from Base Salary is required", "معدل حساب النسبة من اصل الراتب مطلوب"),
                chargeAmountLabel: _m("Amount", "المبلغ"),
                chargeAmountPlaceholder: _m("Amount", "المبلغ"),
                chargeAmountRequired: _m("Amount is required", "المبلغ مطلوب"),
                numberOnlyValidation: _m("Must enter numbers only", "يجب إدخال رقم فقط"),
                periodLabel: _m("Period Unit", "وحدة المدة"),
                periodPlaceholder: _m("Select Allowance", "اختر البدل"),
                periodRequired: _m("Enter Allowance", "ادخل البدل"),
                descriptionLabel: _m("Description", "وصف"),
                descriptionPlaceholder: _m("Description", "وصف"),
                descriptionPercentageLabel: _m("Percentage Description", "وصف حساب النسبة"),
                allowanceTypeLabel: _m("Allowance Type", "نوع البدل"),
                save: _m("Save", "حفظ"),
                cancel: _m("Cancel", "إلغاء")
            }),
            jobOffer: new MessagesGroup({
                title: _m("Job Offer", "العرض الوظيفي"),
                jobOfferNumberLabel: _m("Offer Number", "رقم العرض"),
                jobOfferNumberPlaceholder: _m("Offer Number", "رقم العرض"),
                dateSendLabel: _m("Send Date", "تاريخ الارسال"),
                dateSendPlaceholder: _m("Send Date", "تاريخ الارسال"),
                dateAcceptLabel: _m("Acceptance Date", "تاريخ الموافقة"),
                dateAcceptPlaceholder: _m("Acceptance Date", "تاريخ الموافقة"),
                fileLabel: _m("Attach Offer", "ارفاق العرض"),
                filePlaceholder: _m("job_offer.pdf", "job_offer.pdf"),
                save: _m("Save", "حفظ"),
                cancel: _m("Cancel", "إلغاء")
            }),
            workContract: new MessagesGroup({
                title: _m("Employment Contract", "عقد العمل"),
                myRequests: _m("My Requests", "طلباتي"),
                createRequest: _m("Create Request", "أنشاء طلب"),
                contractNumberLabel: _m("Contract Number", "رقم العقد"),
                contractNumberPlaceholder: _m("Contract Number", "رقم العقد"),
                startDateLabel: _m("Start Date", "تاريخ المباشرة"),
                startDatePlaceholder: _m("Start Date", "تاريخ المباشرة"),
                commencementDateLabel: _m("Commencement Date", "تاريخ البدء"),
                commencementDatePlaceholder: _m("Commencement Date", "تاريخ البدء"),
                contractDurationLabel: _m("Contract Duration", "مدة العقد"),
                contractDurationPlaceholder: _m("Contract Duration", "مدة العقد"),
                contractDurationPattern: _m("Contract duration must be numbers only", "مدة العقد يجب أن تكون أرقام فقط"),
                noticePeriodLabel: _m("Notice Period", "فترة الاشعار"),
                noticePeriodPlaceholder: _m("Notice Period", "فترة الاشعار"),
                noticePeriodPattern: _m("Notice period must be numbers only", "فترة الاشعار يجب أن تكون أرقام فقط"),
                noticePeriodValidation: _m("Notice period must not be greater than contract duration", "فترة الاشعار يجب أن لا تكون أكبر من مدة العقد"),
                probationPeriodLabel: _m("Probation Period", "فترة التجربة"),
                probationPeriodPlaceholder: _m("Probation Period", "فترة التجربة"),
                probationPeriodPattern: _m("Probation period must be numbers only", "فترة التجربة يجب أن تكون أرقام فقط"),
                probationPeriodValidation: _m("Probation period must not be greater than contract duration", "فترة التجربة يجب أن لا تكون أكبر من مدة العقد"),
                typeWorkingHourLabel: _m("Working Hours Type", "نوع ساعات العمل"),
                typeWorkingHourPlaceholder: _m("Select Working Hours Type", "اختر نوع ساعات العمل"),
                workingHoursLabel: _m("Weekly Working Hours", "ساعات العمل الاسبوعية"),
                workingHoursPlaceholder: _m("Weekly Working Hours", "ساعات العمل الاسبوعية"),
                workingHoursPattern: _m("Working hours must be numbers only", "ساعات العمل يجب أن تكون أرقام فقط"),
                annualLeaveLabel: _m("Annual Leave Days", "ايام الاجازات السنوية"),
                annualLeavePlaceholder: _m("Annual Leave Days", "ايام الاجازات السنوية"),
                annualLeavePattern: _m("Annual leave must be numbers only", "ايام الاجازات السنوية يجب أن تكون أرقام فقط"),
                workPlaceLabel: _m("Work Place", "مكان العمل"),
                workPlacePlaceholder: _m("Work Place", "مكان العمل"),
                rightTerminateLabel: _m("Right to Terminate During Probation", "حق الانهاء خلال فترة التجربة"),
                rightTerminatePlaceholder: _m("Select Right to Terminate", "اختر حق الانهاء"),
                attachContractLabel: _m("Attach Contract", "ارفاق العقد"),
                attachContractPlaceholder: _m("contract.pdf", "contract.pdf"),
                hourLabel: _m("hour", "ساعة"),
                dayLabel: _m("day", "يوم"),
                save: _m("Save", "حفظ"),
                cancel: _m("Cancel", "إلغاء")
            })
        ...
        contractTabs: new MessagesGroup({
            ...
            experience: new MessagesGroup({
                experience: _m("Experience", "الخبرات"),
                addCourse: _m("Add Course", "إضافة كورس"),
                companyName: _m("Company Name", "اسم الشركة"),
                entity: _m("Entity", "الجهة"),
                courseName: _m("Course Name", "اسم الدورة التدريبية"),
                accreditationBody: _m("Accreditation Body", "جهة الاعتماد"),
                awardedCertificates: _m("Awarded Certificates", "الشهادات الممنوحة"),
                dateOfObtainingCertificate: _m("Date of Obtaining Certificate", "تاريخ الحصول على الشهادة"),
                certificateExpirationDate: _m("Certificate Expiration Date", "تاريخ انتهاء الشهادة"),
                certificate: _m("Certificate", "الشهادة"),
                attachCertificate: _m("Attach Certificate", "إرفاق الشهادة"),
                clickToUploadFile: _m("Click to upload a file", "اضغط لرفع ملف"),
                save: _m("Save", "حفظ"),
                cancel: _m("Cancel", "إلغاء"),
                clearForm: _m("Clear Form", "مسح النموذج"),
            }),
            academicAndExperienceData: new MessagesGroup({
                experience: _m("Experience", "الخبرات"),
                addCourse: _m("Add Course", "إضافة كورس"),
                employmentAndContractualData: _m("Employment and Contractual Data", "بيانات التوظيف والعقود"),
                financialBenefits: _m("Financial Benefits", "المزايا المالية"),
                companyName: _m("Company Name", "اسم الشركة"),
                entity: _m("Entity", "الجهة"),
                courseName: _m("Course Name", "اسم الدورة التدريبية"),
                accreditationBody: _m("Accreditation Body", "جهة الاعتماد"),
                ...
                attachCertificate: _m("Attach Certificate", "إرفاق الشهادة"),
                clickToUploadFile: _m("Click to upload a file", "اضغط لرفع ملف"),
                allowedTypes: _m("Allowed types: application/pdf, image/jpeg, image/png", "الأنواع المسموحة: application/pdf, image/jpeg, image/png"),
                save: _m("Save", "حفظ"),
                addCourse: _m("Add Course", "إضافة كورس"),
            }),
            cvData: new MessagesGroup({
                cv: _m("CV", "السيرة الذاتية"),
                cvNoData: _m("No Data", "لا توجد بيانات "),
                cvNoDataSubTitle: _m("no data for create data", "لا يوجد بيانات للمستخدم قم باضافة بيانات جديده "),
                uploadCv: _m("Upload CV", "قم بإرفاق المستند"),
                uploadCvDescription: _m("Maximum size is 200MB. PNG, JPG, or PDF formats are allowed.", "الحجم الأقصى هو 200 ميجابايت. يُسمح بتنسيقات PNG أو JPG أو PDF."),
    ...
    nestedTabs: new MessagesGroup({
        ...
        qualificationsData: new MessagesGroup({
            ...
            country: _m("Country", "الدولة"),
            graduationCountry: _m("Graduation Country", "دولة التخرج"),
            ...
            graduationDatePlaceholder: _m("Select Graduation Date", "اختر تاريخ الحصول على الشهادة"),
            studyRate: _m("Study Rate", "المعدلات الدراسية"),
            studyRatePlaceholder: _m("Enter Study Rate", "أدخل المعدلات الدراسية"),
            ...
            attachDocumentPlaceholder: _m("Choose file to attach", "اختر ملف لإرفاقه"),
            save: _m("Save", "حفظ"),
            cancel: _m("Cancel", "إلغاء")
        }),
