...
export const companiesMessages = new MessagesGroup({
  ...
  SubEntitiesTable: new MessagesGroup({
    ...
    PhoneCode: _m("Phone Code", "رمز الهاتف"),
    Nickname: _m("Nickname", "اللقب"),
    BirthdateGregorian: _m("Birthdate (Gregorian)", "تاريخ الميلاد الميلادي"),
    BirthdateHijri: _m("Birthdate (Hijri)", "تاريخ الميلاد الهجري"),
    Nationality: _m("Nationality", "الجنسية"),
    Address: _m("Address", "العنوان"),
    PostalCode: _m("Postal Code", "الرمز البريدي"),
    LandlineNumber: _m("Landline Number", "رقم الأرضي"),
    OtherPhone: _m("Other Phone", "هاتف آخر"),
    ...
    AttendanceToggleToHoliday: _m("Switch to Holiday", "تحويل إلى اجازه"),
    AttendanceToggleToRequired: _m("Switch to Required Attendance", "تحويل إلى مطلوب للحضور"),
    AttendanceUpdateSuccess: _m("Attendance status updated successfully", "تم تحديث حالة الحضور بنجاح"),
    AttendanceUpdateError: _m("Failed to update attendance status", "حدث خطأ أثناء تحديث حالة الحضور"),
    ...
    Whatsapp: _m("WhatsApp", "الواتساب"),
    BankAccount: _m("Bank Account Number", "رقم الحساب البنكي"),
    Linkedin: _m("LinkedIn", "لينكدإن"),
    Facebook: _m("Facebook", "فيسبوك"),
    Instagram: _m("Instagram", "إنستجرام"),
    Telegram: _m("Telegram", "تيليجرام"),
    Snapchat: _m("Snapchat", "سناب شات"),
    Currency: _m("Currency", "العملة"),
    TimeZone: _m("Time Zone", "المنطقة الزمنية"),
    Language: _m("Language", "اللغة"),
    BankInfo: _m("Bank Information", "المعلومات البنكية"),
    SalaryInfo: _m("Salary Information", "معلومات الراتب"),
    EmploymentInfo: _m("Employment Information", "معلومات التوظيف"),
    ContactInfo: _m("Contact Information", "معلومات الاتصال"),
    SocialMedia: _m("Social Media", "وسائل التواصل الاجتماعي"),
    FamilyInfo: _m("Family Information", "معلومات العائلة"),
    AboutMe: _m("About Me", "عني"),
    CV: _m("CV", "السيرة الذاتية"),
    Certificates: _m("Certificates", "الشهادات"),
    Qualification: _m("Qualification", "المؤهلات"),
    Experience: _m("Experience", "الخبرات"),
    Courses: _m("Courses", "الدورات"),
    WorkLicense: _m("Work License", "رخصة العمل"),
    Privileges: _m("Privileges", "الامتيازات"),
    OfficialData: _m("Official Data", "البيانات الرسمية"),
    JobOffer: _m("Job Offer", "عرض العمل"),
    ContractWork: _m("Employment Contract", "عقد العمل"),
