...
export const hrReportsMessages = new MessagesGroup({
  ...
  taskReports: _m("Task Reports", "تقارير المهام"),
  taskReport: new MessagesGroup({
    title: _m("Employee Task Reports", "تقارير مهام الموظفين"),
    description: _m(
      "View employee tasks and their complete approval and work lifecycle.",
      "عرض مهام الموظفين ودورة الاعتماد والتنفيذ كاملة.",
    ),
    employee: _m("Employee", "الموظف"),
    status: _m("Status", "الحالة"),
    all: _m("All", "الكل"),
    dateFrom: _m("From date", "من تاريخ"),
    dateTo: _m("To date", "إلى تاريخ"),
    search: _m("Search by title or serial number", "بحث بالعنوان أو الرقم التسلسلي"),
    filtersTitle: _m("Filter & Search", "التصفية والبحث"),
    reset: _m("Reset filters", "إعادة ضبط الفلاتر"),
    serial: _m("Serial #", "الرقم التسلسلي"),
    task: _m("Task", "المهمة"),
    taskType: _m("Type", "النوع"),
    taskDate: _m("Date", "التاريخ"),
    time: _m("Time (from → to)", "الوقت (من ← إلى)"),
    duration: _m("Duration", "المدة"),
    workedHours: _m("Total worked hours", "إجمالي ساعات العمل"),
    actions: _m("Actions", "الإجراءات"),
    viewDetails: _m("View details", "عرض التفاصيل"),
    details: _m("Task details", "تفاصيل المهمة"),
    close: _m("Close", "إغلاق"),
    empty: _m("No tasks found", "لا توجد مهام"),
    listError: _m("Could not load task reports.", "تعذر تحميل تقارير المهام."),
    detailError: _m("Could not load task details.", "تعذر تحميل تفاصيل المهمة."),
    locations: _m("Locations", "المواقع"),
    targetLocation: _m("Task location", "موقع المهمة"),
    startLocation: _m("Start location", "موقع البدء"),
    endLocation: _m("End location", "موقع الانتهاء"),
    radius: _m("Allowed radius", "النطاق المسموح"),
    workSessions: _m("Work sessions", "جلسات العمل"),
    start: _m("Start", "البدء"),
    end: _m("End", "الانتهاء"),
    minutes: _m("Minutes", "الدقائق"),
    processTimeline: _m("Process timeline", "التسلسل الزمني للإجراءات"),
    noProcesses: _m("No processes recorded.", "لا توجد إجراءات مسجلة."),
    finalStatus: _m("Final Status", "الحالة النهائية"),
    assignedTo: _m("Assigned to", "مسند إلى"),
    actionBy: _m("Action by", "تم الإجراء بواسطة"),
    awaitingAction: _m("Awaiting action", "بانتظار الإجراء"),
    reviewedBy: _m("Reviewed by", "تمت المراجعة بواسطة"),
    additionalHours: _m("Additional hours", "الساعات الإضافية"),
    statuses: new MessagesGroup({
      pending: _m("Pending", "قيد الانتظار"),
      approved: _m("Approved", "معتمدة"),
      rejected: _m("Rejected", "مرفوضة"),
      in_progress: _m("In progress", "قيد التنفيذ"),
      paused: _m("Paused", "متوقفة مؤقتاً"),
      completed: _m("Completed", "مكتملة"),
      cancelled: _m("Cancelled", "ملغاة"),
    }),
    processTypes: new MessagesGroup({
      create: _m("Create Task", "إنشاء المهمة"),
      start: _m("Start Task", "بدء المهمة"),
      end: _m("End Task", "إنهاء المهمة"),
      approval: _m("Completion Approval", "اعتماد الإكمال"),
      extension: _m("Duration Extension", "تمديد المدة"),
    }),
  }),
