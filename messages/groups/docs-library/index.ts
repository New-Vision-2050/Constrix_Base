...
export const docsLibraryMessages = new MessagesGroup({
  ...
  statistics: new MessagesGroup({
    ...
    activityStats: new MessagesGroup({
      ...
      description: _m(
        "Average active documents for the company",
        "معدل المستندات السارية للشركة",
      ),
      title2: _m("Expired Documents", "المستندات المنتهية"),
      description2: _m(
        "Average expired documents for the company",
        "معدل المستندات المنتهية للشركة",
      ),
    }),
    expirationStats: new MessagesGroup({
      title: _m(
        "Documents nearing expiration",
        "المستندات المقتربة على الانتهاء",
      ),
  ...
  shareDialog: new MessagesGroup({
    ...
    notes: _m(
      "Please enter the email address of the user you want to share the files with",
      "",
    ),
  }),
  publicDocs: new MessagesGroup({
    ...
    directoryPasswordDialog: new MessagesGroup({
      ...
      description: _m(
        "This directory is protected by a password. Please enter the password to access it.",
        "هذا المجلد محمي بكلمة المرور. يرجى إدخال كلمة المرور للاستفادة منه.",
      ),
    ...
    shareDialog: new MessagesGroup({
      ...
      sharedSuccessfully: _m(
        ...
        "تم مشاركة الملف بنجاح",
      ),
      linkCopiedSuccessfully: _m(
      ...
      notes: _m(
        "Please enter the email address of the user you want to share the files with",
        "الرجاء كتابة البريد الالكتروني الذي تود مشاركة الملفات معه",
      ),
    }),
    ...
    createNewFileDialog: new MessagesGroup({
      ...
      reference_numberPlaceholder: _m(
