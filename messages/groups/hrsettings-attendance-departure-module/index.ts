...
export const hrsettingsAttendanceDepartureModuleMessages = new MessagesGroup({
  ...
  attendanceDeterminants: new MessagesGroup({
    ...
    determinantSettings: new MessagesGroup({
      ...
      columnEmployeeStatus: _m("Employee Status", "حالة الموظف"),
      columnAttendanceStatus: _m("Attendance Status", "حالة الحضور"),
    ...
    shifts: new MessagesGroup({
      ...
      workPeriods: new MessagesGroup({
        ...
        weekly_work_hours_label: _m("Weekly work hours", "عدد ساعات العمل خلال الأسبوع"),
        weekly_work_hours_unit: _m("h", "س"),
        ...
        extension_minutes_label: _m("Shift extension time", "وقت الامتداد بعد نهاية الدوام"),
        extension_minutes_unit: _m("m", "د"),
        can_clock_in_before_label: _m("Clock-in deadline after shift start", "الحد الأقصى لتسجيل الحضور بعد بدء الدوام"),
        can_clock_in_before_unit: _m("m", "د"),
        can_clock_in_before_enabled: _m("Enabled", "مفعّل"),
        max_over_time_label: _m("Maximum overtime", "الحد الاقصى للوقت الإضافي"),
        max_over_time_unit: _m("m", "د"),
        is_overtime_before_early_clock_in_label: _m("Overtime before early clock-in window", "احتساب وقت إضافي قبل فترة الحضور المبكر"),
        is_overtime_after_extension_hours_shift_label: _m("Overtime after extension hours", "احتساب وقت إضافي بعد ساعات الامتداد"),
        is_after_finish_working_hours_label: _m("Overtime after completing work hours", "احتساب وقت إضافي بعد اكتمال ساعات العمل"),
        not_set: _m("Not set", "غير محدد"),
        enabled: _m("Enabled", "مفعّل"),
        disabled: _m("Disabled", "غير مفعّل"),
      }),
    }),
  }),
