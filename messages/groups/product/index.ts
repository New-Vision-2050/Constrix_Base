...
export const productMessages = new MessagesGroup({
    ...
    add: new MessagesGroup({
      ...
      fields: new MessagesGroup({
        ...
        description: new MessagesGroup({
          ...
          placeholder: _m(
            "Description of this product which may be a line or exceed that with...",
            "وصف هذا المنتج الذي قد يكون سطرا أو يتجاوز ذلك بـ..."
          ),
        }),
        ...
        isVisible: new MessagesGroup({
          ...
          description: _m(
            "If you choose not to display the product in the store, the product will be saved in products and will not be shown to the user in your store",
            "في حالة عدم اختيارك عرض المنتج على المتجر سيتم حفظ المنتج في المنتجات ولن يتم اظهاره للمستخدم على المتجر الخاص بك"
          ),
        }),
        mainImage: new MessagesGroup({
          ...
          dragText: _m(
            "Maximum image size: 2160 × 2160 - 3MB",
        ...
        taxes: new MessagesGroup({
          ...
          noTaxes: _m(
            "No taxes added. Click 'Add' to add a new tax.",
            'لا توجد ضرائب مضافة. انقر على "إضافة" لإضافة ضريبة جديدة.'
          ),
        }),
  ...
  validation: new MessagesGroup({
    ...
    descriptionAr: _m(
      ...
      "الوصف باللغة العربية مطلوب"
    ),
    descriptionEn: _m(
      "English description is required",
      "الوصف باللغة الإنجليزية مطلوب"
    ),
    ...
    discountValue: _m(
      ...
      "يجب أن تكون قيمة الخصم رقماً موجباً"
    ),
    vatPercentage: _m(
      "VAT percentage must be between 0 and 100",
      "يجب أن تكون نسبة ضريبة القيمة المضافة بين 0 و 100"
    ),
    fillRequired: _m(
